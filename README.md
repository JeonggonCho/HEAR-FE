...
| Splash                                                             | 홈                                                                                                                           |
|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
| <img src="./readme_assets/splash_page.gif" alt="splash" width=250> | <img src="./readme_assets/home_page.gif" alt="home" width=250>                                                              |
...
| 로그인                                                              | 회원가입                                                               | 비밀번호 찾기                                                                        |
|------------------------------------------------------------------|--------------------------------------------------------------------|--------------------------------------------------------------------------------|
| <img src="./readme_assets/login_page.gif" alt="login" width=250> | <img src="./readme_assets/signin_page.gif" alt="signin" width=250> | <img src="./readme_assets/find_password_page.gif" alt="find_password" width=250> |
| - 실시간 유효성 검사를 통해 한양대 이메일만 이용 가능                                  | - nodemailer를 이용한 한양대 이메일 인증<br/>- 학생 정보 입력                        | - 기존 비밀번호 제거 후, 새 비밀번호를 이메일로 전송                                                |

| 학생 프로필                                                                               | 조교 프로필                                                                                   | 회원정보 수정                                                                            |
|--------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| <img src="./readme_assets/student_profile_page.gif" alt="student_profile" width=250> | <img src="./readme_assets/assistant_profile_page.gif" alt="assistant_profile" width=250> | <img src="./readme_assets/change_profile_page.gif" alt="change_profile" width=250> |
| - 기본 정보 및 교육 이수 현황, 경고 횟수 확인 가능<br/>- 내 예약, 이용 내역, 문의 내역, 경고 내역 확인 가능                | - 조교 기본 정보 확인 가능<br/>- 예약, 유저, 기기, 교육의 관리 기능 제공                                          | - 이름, 학번, 전화번호 수정 가능                                                               |

| 테마 및 언어 설정                                                                          |
|-------------------------------------------------------------------------------------|
| <img src="./readme_assets/setting_page.gif" alt="setting" width=250>                |
...
| 사용법 목록                                                                                 | 사용법                                                                          | 이미지 뷰어                                                                                            |
|----------------------------------------------------------------------------------------|------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| <img src="./readme_assets/instruction_list_page.gif" alt="instruction_list" width=250> | <img src="./readme_assets/instruction_page.gif" alt="instruction" width=250> | <img src="./readme_assets/instruction_image_viewer.gif" alt="instruction_image_viewer" width=250> |
...
|------------------------------------------------------------------------------------------|-----------|-------|
| <img src="./readme_assets/reservation_laser_page.gif" alt="reservation_laser" width=250> |           |       |
| - 기기 및 시간을 선택<br/>- 최대 일일 2회 / 주 4회 예약 가능                                                |           |       |

| 톱 예약                                                                                         | 사출 성형기 예약                                                                                    | CNC 예약                                                                               |
|----------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|
| <img src="./readme_assets/reservation_saw_page.gif" alt="reservation_saw" width=250>         | <img src="./readme_assets/reservation_vacuum_page.gif" alt="reservation_vacuum" width=250>   | <img src="./readme_assets/reservation_cnc_page.gif" alt="reservation_cnc" width=250> |
...
| 공지사항 작성                                                                            | 공지사항                                                                             |
|------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| <img src="./readme_assets/writing_notice_page.gif" alt="writing_notice" width=250> | <img src="./readme_assets/notice_detail_page.gif" alt="notice_detail" width=250> |
| - 제목과 본문 작성 가능<br/>- 본문은 최소 10자 이상 작성하도록 실시간 검사                                    | - 공지사항 제목과 본문을 확인 가능<br/>- 댓글 작성 기능<br/>- 댓글 좋아요 기능                              |

| 문의 및 피드백 작성                                                                            | 문의 및 피드백                                                                           |
|----------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| <img src="./readme_assets/writing_feedback_page.gif" alt="writing_feedback" width=250> | <img src="./readme_assets/inquiry_detail_page.gif" alt="inquiry_detail" width=250> |
...
|--------------------------------------------------------------------------------------|--------------------------------------------------------------------------|--------------------------------------------------------------------------------------|
| <img src="./readme_assets/education_intro_page.gif" alt="education_intro" width=250> | <img src="./readme_assets/education_page.gif" alt="education" width=250> | <img src="./readme_assets/education_check_page.gif" alt="education_check" width=250> |
...
| 예약                                                                                   | 이용 |
|--------------------------------------------------------------------------------------|----|
| <img src="./readme_assets/my_reservations_page.gif" alt="my_reservations" width=250> |    |
| - 유저가 예약한 기기 목록 확인 가능<br/>- 기기 별로 필터링 가능<br/>- 전체 또는 일부 선택으로 예약 취소 가능                |    |

| 문의                                                                             | 경고                                                                           |
|--------------------------------------------------------------------------------|------------------------------------------------------------------------------|
| <img src="./readme_assets/my_inquiries_page.gif" alt="my_inquiries" width=250> | <img src="./readme_assets/my_warnings_page.gif" alt="my_warnings" width=250> |
